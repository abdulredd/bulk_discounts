    ...
    describe "When I visit my bulk discount show page" do
      ...
      describe "4: Merchant Bulk Discount Show" do
        it "Then I see the bulk discount's quantity threshold and percentage discount" do
          expect(page).to have_content("Quantity Threshold: #{@discount_1.quantity_threshold} min")
          expect(page).to have_content("Discount Percentage: #{@discount_1.percentage}% off")
        end
      end

      describe "5: Merchant Bulk Discount Edit (Part 1)" do
